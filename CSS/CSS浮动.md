...
![](../Picture/CSS浮动/练习1.png)

如果子盒子的宽度大于父盒子，会有溢出状态

![](../Picture/CSS浮动/练习2.png)

向右贴边的原理与向左相同

### 3、浮动依次贴边练习

![](../Picture/CSS浮动/贴边练习.png)
...
![](../Picture/CSS浮动/设置了浮动.png) ![](../Picture/CSS浮动/未设置浮动1.png)
...
![](../Picture/CSS浮动/脱标.png)

### 6、字围现象

同级元素中前面元素如果浮动了，后面的标准流会占住前面元素的位置，后面的盒子如果有文字，文字会围绕浮动元素进行加载

![](../Picture/CSS浮动/字围.png)

可以利用字围现象进行环境进行美化

![](../Picture/CSS浮动/利用字围进行美化.png)
